    ...
    public sealed class NP_X2EnterWorldResponsePacket : NetPacket
    {
        ...
        public NP_X2EnterWorldResponsePacket() : base(05, 0x00)
        {
            ...
            */
            ...
            const string pubKey = "";
            ns.WriteHex(pubKey, pubKey.Length);  //pubKey 260 байт
            ns.Write((int)0x058B3F77); //natAddr 773F8B05 CDC9
            ns.Write((ushort)0xC9CD); //natPort
        }
    }
}
